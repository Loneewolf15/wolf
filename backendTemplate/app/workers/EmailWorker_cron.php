...
class EmailWorkerCron extends Controller
{
    private $queue;
    ...
    {
        echo "Email worker cron started. Processing available jobs...\n";

        // Process all available jobs in the queue and then exit
        ...
        echo "Email worker cron finished.\n";
    }
    ...
    /**
     * Public method to handle jobs from unified worker
     */
    public function handleJobPublic($job)
    {
        $this->handleJob($job);
    }
}
